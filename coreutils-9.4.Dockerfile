...
# base
# ========================================
FROM ubuntu:22.04 as klee-coreutils-base
...
RUN wget "http://ftp.gnu.org/gnu/coreutils/coreutils-9.4.tar.xz" \
...
RUN pip3 install --upgrade -v "wllvm==1.3.1"

ENV LLVM_COMPILER clang
ENV LLVM_CC_NAME "clang-13"
ENV LLVM_CXX_NAME "clang-13"
ENV LLVM_LINK_NAME "llvm-link-13"
ENV CC wllvm
